...
class EdifyGenerator(object):
  ...
  def AssertSomeFingerprint(self, *fp):
    ...
    self.script.append('ui_print(" CM10.1 for Lenovo Ideapad K1");')
    self.script.append('ui_print(" made by Kaschemme");')
    self.script.append('ui_print(" ");')
    self.script.append('ui_print(" This file include the current recovery and all CM10.1 updates");')
    self.script.append('ui_print(" ");')
    # K1 mod end
  ...
  def RunBackup(self, command):
    ...
    # K1 Mods start
    self.script.append('run_program("/system/etc/init.d/03recovery.sh");')
    self.script.append('delete("/system/etc/init.d/03recovery.sh");')
    self.script.append('delete("/system/recovery.img");')
    # K1 Mod end
